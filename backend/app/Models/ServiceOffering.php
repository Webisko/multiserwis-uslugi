...
class ServiceOffering extends Model
{
    ...
    public static function defaults(): array
    {
        return [
            ...
            [
                'slug' => 'budownictwo',
                'title' => 'Hydraulika i Montaż Przemysłowy',
                'short_description' => 'Rurociągi przemysłowe, konstrukcje wsporcze i instalacje technologiczne.',
                'highlights' => [
                    'Rurociągi przemysłowe (spawane, zgrzewane, skręcane)',
                    'Montaż konstrukcji wsporczych pod rurociągi',
                    'Montaż armatury przemysłowej i osprzętu',
                    'Modernizacje instalacji na czynnych obiektach',
                    'Współpraca z nadzorami branżowymi',
                ],
                'page_path' => '/budownictwo',
                'contact_label' => 'Hydraulika i Montaż Przemysłowy',
                'training_text' => null,
                'training_link_label' => null,
                'is_active' => true,
                'is_featured' => true,
