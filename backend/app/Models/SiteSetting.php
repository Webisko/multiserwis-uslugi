...
class SiteSetting extends Model
{
    ...
    protected $fillable = [
        ...
        'services_phone_href',
        'services_secondary_phone_value',
        'services_secondary_phone_href',
    ...
    public static function defaults(): array
    {
        return [
            ...
            'services_phone_value' => '730 101 000',
            'services_phone_href' => 'tel:+48730101000',
            'services_secondary_phone_value' => '733 929 100',
            'services_secondary_phone_href' => 'tel:+48733929100',
            'training_phone_label' => 'Szkolenia',
            'training_phone_value' => '730 202 000',
            'training_phone_href' => 'tel:+48730202000',
            ...
            'company' => [
                ...
                'phones' => [
                    'services' => [
                        ...
                        'secondaryValue' => $this->services_secondary_phone_value,
                        'secondaryHref' => $this->services_secondary_phone_href,
                    ],
                    'training' => [
