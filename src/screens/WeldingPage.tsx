          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="flex flex-col md:flex-row gap-6 items-stretch">
               <div className="flex-grow bg-industrial-800 p-8 rounded-xl text-center md:text-left flex flex-col md:flex-row items-center justify-between gap-6">
                  ...
                  <a href="/kontakt" className="bg-industrial-accent text-industrial-900 px-6 py-3 rounded font-bold hover:bg-industrial-accentHover transition-colors whitespace-nowrap">
                    Skontaktuj się
                  </a>
               </div>
